            ...
            <View style={styles.card} key={index}>
              ...
              <View>
                <View style={styles.cardText}>
                  <Text>Point A:</Text>
                  <Text style={{ color: '#4250CF' }}>{activity.pointA}</Text>
                </View>
                <View style={styles.cardText}>
                  <Text>Point B:</Text>
                  <Text style={{ color: '#4250CF' }}>{activity.pointB}</Text>
                </View>

                <Text style={styles.cardText}>
                  Calories:{' '}
                  <Text style={{ color: '#4250CF' }}>
                    {activity.burnedCalories ? activity.burnedCalories : 0}
                  </Text>
                </Text>
                <Text style={styles.cardText}>
                  Drank Water:{' '}
                  <Text style={{ color: '#4250CF' }}>
                    {activity.drankWater ? 'Yes' : 'No'}
                  </Text>
                </Text>
              ...
              <View style={styles.map}>
                ...
                <MapView
                  ...
                  initialRegion={{
                    latitude:
                      (marker1Coordinate.latitude +
                        marker2Coordinate.latitude) /
                      2,
                    longitude:
                      (marker1Coordinate.longitude +
                        marker2Coordinate.longitude) /
                      2,
                    latitudeDelta:
                      Math.abs(
                        marker1Coordinate.latitude - marker2Coordinate.latitude
                      ) + 0.04,
                    longitudeDelta:
                      Math.abs(
                        marker1Coordinate.longitude -
